...
#include "VyNode_Nft_GetContracts.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetContracts : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetContractsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetContracts")};
};