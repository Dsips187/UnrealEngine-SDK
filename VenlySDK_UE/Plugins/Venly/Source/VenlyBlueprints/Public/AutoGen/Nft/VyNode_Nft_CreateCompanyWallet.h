...
#include "VyNode_Nft_CreateCompanyWallet.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_CreateCompanyWallet : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateCompanyWalletCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("CreateCompanyWallet")};
};