...
#include "VyNode_Ext_GetMarketUserForUser.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Ext_GetMarketUserForUser : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetMarketUserForUserCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Provider")};
	inline static const FName NAME_AuthoredName{TEXT("GetMarketUserForUser")};
};