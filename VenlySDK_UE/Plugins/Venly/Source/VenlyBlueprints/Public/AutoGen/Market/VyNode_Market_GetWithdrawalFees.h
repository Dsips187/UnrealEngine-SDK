...
#include "VyNode_Market_GetWithdrawalFees.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetWithdrawalFees : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetWithdrawalFeesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetWithdrawalFees")};
};