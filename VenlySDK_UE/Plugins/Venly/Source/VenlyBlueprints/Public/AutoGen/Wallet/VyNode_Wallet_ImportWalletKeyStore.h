...
#include "VyNode_Wallet_ImportWalletKeyStore.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ImportWalletKeyStore : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnImportWalletKeyStoreCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ImportWalletKeyStore")};
};