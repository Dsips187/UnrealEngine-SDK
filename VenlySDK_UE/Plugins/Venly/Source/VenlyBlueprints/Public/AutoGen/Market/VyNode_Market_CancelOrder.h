...
#include "VyNode_Market_CancelOrder.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CancelOrder : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_AuthoredName{TEXT("CancelOrder")};
};