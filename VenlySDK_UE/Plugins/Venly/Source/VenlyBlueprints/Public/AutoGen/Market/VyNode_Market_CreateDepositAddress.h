...
#include "VyNode_Market_CreateDepositAddress.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CreateDepositAddress : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateDepositAddressCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CreateDepositAddress")};
};