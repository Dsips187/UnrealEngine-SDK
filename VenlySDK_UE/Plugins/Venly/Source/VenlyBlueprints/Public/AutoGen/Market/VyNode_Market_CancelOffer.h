...
#include "VyNode_Market_CancelOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CancelOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCancelOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CancelOffer")};
};