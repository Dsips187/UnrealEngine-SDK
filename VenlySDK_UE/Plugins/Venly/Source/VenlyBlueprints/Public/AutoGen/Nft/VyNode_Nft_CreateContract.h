...
#include "VyNode_Nft_CreateContract.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_CreateContract : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateContractCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("CreateContract")};
};