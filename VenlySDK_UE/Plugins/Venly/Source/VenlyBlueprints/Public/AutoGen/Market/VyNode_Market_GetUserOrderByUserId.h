...
#include "VyNode_Market_GetUserOrderByUserId.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserOrderByUserId : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserOrderByUserIdCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserOrderByUserId")};
};