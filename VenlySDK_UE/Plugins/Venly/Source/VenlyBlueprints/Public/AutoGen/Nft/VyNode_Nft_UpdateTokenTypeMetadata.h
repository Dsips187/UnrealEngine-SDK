...
#include "VyNode_Nft_UpdateTokenTypeMetadata.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_UpdateTokenTypeMetadata : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateTokenTypeMetadataCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateTokenTypeMetadata")};
};