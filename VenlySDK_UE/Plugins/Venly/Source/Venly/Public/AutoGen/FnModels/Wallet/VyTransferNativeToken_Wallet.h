...
struct FVyTransferNativeTokenRequest : public FVyDTO
{
	GENERATED_BODY()
...
class UVyTransferNativeTokenRequestRef : public UObject
{
	GENERATED_BODY()
	public:
...
USTRUCT(BlueprintType)
struct FVyTransferNativeTokenResponse : public FVyApiResponse
{
	GENERATED_BODY();
