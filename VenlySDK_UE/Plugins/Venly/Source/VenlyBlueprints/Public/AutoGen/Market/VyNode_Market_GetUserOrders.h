...
#include "VyNode_Market_GetUserOrders.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserOrders : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserOrdersCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserOrders")};
};