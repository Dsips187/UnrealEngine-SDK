...
#include "VyNode_Market_AddOfferSignature.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_AddOfferSignature : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnAddOfferSignatureCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("AddOfferSignature")};
};