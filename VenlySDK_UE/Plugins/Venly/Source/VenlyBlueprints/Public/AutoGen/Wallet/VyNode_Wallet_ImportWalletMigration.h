...
#include "VyNode_Wallet_ImportWalletMigration.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ImportWalletMigration : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnImportWalletMigrationCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ImportWalletMigration")};
};