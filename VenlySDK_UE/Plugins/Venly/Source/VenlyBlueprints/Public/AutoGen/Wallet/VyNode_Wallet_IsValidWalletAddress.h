...
#include "VyNode_Wallet_IsValidWalletAddress.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_IsValidWalletAddress : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnIsValidWalletAddressCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("IsValidWalletAddress")};
};