...
#include "K2BeamNode_ApiRequest_VenlyProviderServiceMsExecute.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_VenlyProviderServiceMsExecute"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /Execute  of the VenlyProviderServiceMs Service. 
*/
UCLASS(meta=(BeamFlow))
class VENLYSDK_UE_BEAMABLE_MICROSERVICESBP_API UK2BeamNode_ApiRequest_VenlyProviderServiceMsExecute : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
