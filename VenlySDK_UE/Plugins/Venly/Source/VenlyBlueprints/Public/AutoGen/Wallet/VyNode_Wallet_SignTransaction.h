...
#include "VyNode_Wallet_SignTransaction.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_SignTransaction : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnSignTransactionCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("SignTransaction")};
};