...
#include "VyNode_Wallet_ExecuteContract.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ExecuteContract : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnExecuteContractCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ExecuteContract")};
};