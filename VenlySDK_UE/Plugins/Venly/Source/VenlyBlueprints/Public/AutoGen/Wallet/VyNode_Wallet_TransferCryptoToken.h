...
#include "VyNode_Wallet_TransferCryptoToken.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_TransferCryptoToken : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnTransferCryptoTokenCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("TransferCryptoToken")};
};