...
#include "VyNode_Market_UpdateFulfillmentAssociation.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_UpdateFulfillmentAssociation : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateFulfillmentAssociationCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateFulfillmentAssociation")};
};