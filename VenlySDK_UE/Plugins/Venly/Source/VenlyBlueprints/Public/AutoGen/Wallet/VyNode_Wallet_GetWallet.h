...
#include "VyNode_Wallet_GetWallet.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetWallet : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetWalletCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetWallet")};
};