...
#include "VyNode_Wallet_GetExchangeRate.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetExchangeRate : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetExchangeRateCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetExchangeRate")};
};