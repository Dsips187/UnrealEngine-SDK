...
#include "VyNode_Market_PrepareOfferTransaction.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_PrepareOfferTransaction : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnPrepareOfferTransactionCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("PrepareOfferTransaction")};
};