...
#include "VyNode_Wallet_IsValidSignature.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_IsValidSignature : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnIsValidSignatureCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("IsValidSignature")};
};