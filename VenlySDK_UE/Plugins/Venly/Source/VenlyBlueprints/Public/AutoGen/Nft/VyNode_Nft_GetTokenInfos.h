...
#include "VyNode_Nft_GetTokenInfos.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetTokenInfos : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTokenInfosCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetTokenInfos")};
};