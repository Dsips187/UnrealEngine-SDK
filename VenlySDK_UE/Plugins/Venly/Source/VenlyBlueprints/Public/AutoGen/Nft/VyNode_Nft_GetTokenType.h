...
#include "VyNode_Nft_GetTokenType.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetTokenType : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTokenTypeCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetTokenType")};
};