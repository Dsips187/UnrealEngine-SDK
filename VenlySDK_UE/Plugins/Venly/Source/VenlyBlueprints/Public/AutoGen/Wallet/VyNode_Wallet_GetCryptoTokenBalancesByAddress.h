...
#include "VyNode_Wallet_GetCryptoTokenBalancesByAddress.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetCryptoTokenBalancesByAddress : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCryptoTokenBalancesByAddressCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetCryptoTokenBalancesByAddress")};
};