...
#include "VyNode_Market_GetUserFulfillments.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserFulfillments : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserFulfillmentsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserFulfillments")};
};