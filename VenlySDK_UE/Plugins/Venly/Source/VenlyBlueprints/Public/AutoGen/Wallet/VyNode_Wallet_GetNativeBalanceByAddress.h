...
#include "VyNode_Wallet_GetNativeBalanceByAddress.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetNativeBalanceByAddress : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetNativeBalanceByAddressCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetNativeBalanceByAddress")};
};