...
#include "VyNode_Wallet_ResubmitTransaction.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ResubmitTransaction : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnResubmitTransactionCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ResubmitTransaction")};
};