...
#include "VyNode_Wallet_GetCryptoTokenBalances.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetCryptoTokenBalances : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCryptoTokenBalancesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetCryptoTokenBalances")};
};