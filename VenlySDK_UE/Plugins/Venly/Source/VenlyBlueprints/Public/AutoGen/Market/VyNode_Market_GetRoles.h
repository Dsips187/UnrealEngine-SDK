...
#include "VyNode_Market_GetRoles.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetRoles : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetRolesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetRoles")};
};