...
#include "VyNode_Nft_DeleteCompanyWallet.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_DeleteCompanyWallet : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_AuthoredName{TEXT("DeleteCompanyWallet")};
};