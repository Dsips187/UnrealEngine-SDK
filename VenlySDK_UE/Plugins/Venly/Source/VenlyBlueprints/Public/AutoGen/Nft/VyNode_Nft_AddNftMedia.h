...
#include "VyNode_Nft_AddNftMedia.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_AddNftMedia : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnAddNftMediaCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("AddNftMedia")};
};