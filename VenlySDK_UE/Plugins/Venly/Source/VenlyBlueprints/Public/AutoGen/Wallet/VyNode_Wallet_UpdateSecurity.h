...
#include "VyNode_Wallet_UpdateSecurity.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_UpdateSecurity : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateSecurityCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateSecurity")};
};