...
#include "VyNode_Wallet_GetTransactionFees.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetTransactionFees : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTransactionFeesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetTransactionFees")};
};