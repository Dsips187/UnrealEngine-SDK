...
#include "VyNode_Market_GetUserOrder.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserOrder : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserOrderCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserOrder")};
};