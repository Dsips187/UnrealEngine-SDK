...
#include "VyNode_Wallet_TransferNativeToken.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_TransferNativeToken : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnTransferNativeTokenCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("TransferNativeToken")};
};