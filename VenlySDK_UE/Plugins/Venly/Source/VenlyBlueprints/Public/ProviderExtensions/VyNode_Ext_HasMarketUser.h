...
#include "VyNode_Ext_HasMarketUser.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Ext_HasMarketUser : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnHasMarketUserCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Provider")};
	inline static const FName NAME_AuthoredName{TEXT("HasMarketUser")};
};