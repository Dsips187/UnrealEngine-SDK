...
#include "VyNode_Wallet_ExportWallet.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ExportWallet : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnExportWalletCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ExportWallet")};
};