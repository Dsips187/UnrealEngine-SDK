...
#include "VyNode_Nft_GetToken.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetToken : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTokenCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetToken")};
};