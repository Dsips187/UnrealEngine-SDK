...
#include "VyNode_Market_GetCollection.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetCollection : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCollectionCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetCollection")};
};