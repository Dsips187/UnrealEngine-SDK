...
#include "VyNode_Market_CreateSaleOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CreateSaleOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateSaleOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CreateSaleOffer")};
};