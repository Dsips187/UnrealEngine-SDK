...
#include "VyNode_Market_ClaimDailyReward.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_ClaimDailyReward : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_AuthoredName{TEXT("ClaimDailyReward")};
};