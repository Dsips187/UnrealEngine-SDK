...
#include "VyNode_Nft_MintTokens.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_MintTokens : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnMintTokensCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("MintTokens")};
};