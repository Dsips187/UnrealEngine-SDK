...
#include "VyNode_Nft_GetCompanyWallets.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetCompanyWallets : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCompanyWalletsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetCompanyWallets")};
};