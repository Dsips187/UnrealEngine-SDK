...
#include "VyNode_Nft_CreateTokenType.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_CreateTokenType : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateTokenTypeCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("CreateTokenType")};
};