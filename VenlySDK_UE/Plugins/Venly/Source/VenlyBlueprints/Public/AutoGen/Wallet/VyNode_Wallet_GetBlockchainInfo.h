...
#include "VyNode_Wallet_GetBlockchainInfo.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetBlockchainInfo : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetBlockchainInfoCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetBlockchainInfo")};
};