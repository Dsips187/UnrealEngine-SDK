...
#include "VyNode_Market_GetUserOffersByUserId.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserOffersByUserId : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserOffersByUserIdCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserOffersByUserId")};
};