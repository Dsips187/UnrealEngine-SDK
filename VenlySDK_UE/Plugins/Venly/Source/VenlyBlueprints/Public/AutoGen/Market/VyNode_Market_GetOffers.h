...
#include "VyNode_Market_GetOffers.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetOffers : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetOffersCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetOffers")};
};