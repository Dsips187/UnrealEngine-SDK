...
#include "VyNode_Market_GetDepositAddresses.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetDepositAddresses : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetDepositAddressesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetDepositAddresses")};
};