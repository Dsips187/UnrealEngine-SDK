...
#include "VyNode_Market_UpdateOrder.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_UpdateOrder : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateOrderCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateOrder")};
};