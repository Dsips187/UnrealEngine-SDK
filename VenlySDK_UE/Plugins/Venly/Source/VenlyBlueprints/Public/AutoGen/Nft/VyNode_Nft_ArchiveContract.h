...
#include "VyNode_Nft_ArchiveContract.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_ArchiveContract : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_AuthoredName{TEXT("ArchiveContract")};
};