...
#include "VyNode_Market_GetFees.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetFees : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetFeesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetFees")};
};