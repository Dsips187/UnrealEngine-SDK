...
#include "VyNode_Market_GetCreditHistory.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetCreditHistory : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCreditHistoryCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetCreditHistory")};
};