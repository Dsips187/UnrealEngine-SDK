...
#include "VyNode_Wallet_ReadContract.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ReadContract : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnReadContractCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ReadContract")};
};