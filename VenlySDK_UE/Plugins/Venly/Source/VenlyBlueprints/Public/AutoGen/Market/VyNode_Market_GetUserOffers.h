...
#include "VyNode_Market_GetUserOffers.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserOffers : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserOffersCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserOffers")};
};