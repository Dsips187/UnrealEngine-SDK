...
#include "VyNode_Market_UpdateUserPreferences.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_UpdateUserPreferences : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateUserPreferencesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateUserPreferences")};
};