...
#include "VyNode_Market_PurchaseOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_PurchaseOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnPurchaseOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("PurchaseOffer")};
};