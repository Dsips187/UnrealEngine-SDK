...
#include "VyNode_Nft_GetTokenTypes.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetTokenTypes : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTokenTypesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetTokenTypes")};
};