...
#include "VyNode_Nft_GetContractMetadata.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetContractMetadata : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetContractMetadataCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetContractMetadata")};
};