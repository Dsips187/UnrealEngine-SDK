...
#include "VyNode_Wallet_ImportWalletWif.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ImportWalletWif : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnImportWalletWifCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ImportWalletWif")};
};