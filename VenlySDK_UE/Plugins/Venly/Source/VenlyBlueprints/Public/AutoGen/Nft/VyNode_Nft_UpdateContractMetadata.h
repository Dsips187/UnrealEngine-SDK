...
#include "VyNode_Nft_UpdateContractMetadata.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_UpdateContractMetadata : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateContractMetadataCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateContractMetadata")};
};