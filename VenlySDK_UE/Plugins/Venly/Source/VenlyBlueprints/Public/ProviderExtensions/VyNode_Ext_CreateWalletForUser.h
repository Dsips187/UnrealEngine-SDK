...
#include "VyNode_Ext_CreateWalletForUser.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Ext_CreateWalletForUser : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateWalletForUserCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Provider")};
	inline static const FName NAME_AuthoredName{TEXT("CreateWalletForUser")};
};