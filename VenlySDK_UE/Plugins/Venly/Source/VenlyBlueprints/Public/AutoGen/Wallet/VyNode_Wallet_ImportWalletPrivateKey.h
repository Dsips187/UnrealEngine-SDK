...
#include "VyNode_Wallet_ImportWalletPrivateKey.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ImportWalletPrivateKey : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnImportWalletPrivateKeyCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ImportWalletPrivateKey")};
};