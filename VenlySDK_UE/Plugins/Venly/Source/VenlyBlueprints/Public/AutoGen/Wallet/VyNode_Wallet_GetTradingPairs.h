...
#include "VyNode_Wallet_GetTradingPairs.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetTradingPairs : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTradingPairsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetTradingPairs")};
};