...
#include "VyNode_Market_GetUserProfile.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserProfile : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserProfileCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserProfile")};
};