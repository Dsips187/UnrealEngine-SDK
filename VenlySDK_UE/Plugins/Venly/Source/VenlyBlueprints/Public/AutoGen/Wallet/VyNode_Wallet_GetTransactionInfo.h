...
#include "VyNode_Wallet_GetTransactionInfo.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetTransactionInfo : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTransactionInfoCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetTransactionInfo")};
};