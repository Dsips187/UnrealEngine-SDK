...
#include "VyNode_Market_ApproveOfferMetaTx.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_ApproveOfferMetaTx : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnApproveOfferMetaTxCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("ApproveOfferMetaTx")};
};