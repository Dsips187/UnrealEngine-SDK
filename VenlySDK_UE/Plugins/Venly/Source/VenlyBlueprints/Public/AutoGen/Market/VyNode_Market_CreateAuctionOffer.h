...
#include "VyNode_Market_CreateAuctionOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CreateAuctionOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateAuctionOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CreateAuctionOffer")};
};