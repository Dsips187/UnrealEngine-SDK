...
#include "VyNode_Market_UpdateOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_UpdateOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateOffer")};
};