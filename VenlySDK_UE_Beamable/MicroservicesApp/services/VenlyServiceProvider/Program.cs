...
namespace Beamable.VenlyProviderService
{
	...
	{
		/// <summary>
		/// The entry point for the <see cref="VenlyProviderService"/> service.
		/// </summary>
		public static async Task Main()
		{
			// inject data from the CLI
			await MicroserviceBootstrapper.Prepare<VenlyProviderService>();
			
			// load environment variables from local file
			LoadEnvironmentVariables();
			
			// run the Microservice code
			await MicroserviceBootstrapper.Start<VenlyProviderService>();
		}
