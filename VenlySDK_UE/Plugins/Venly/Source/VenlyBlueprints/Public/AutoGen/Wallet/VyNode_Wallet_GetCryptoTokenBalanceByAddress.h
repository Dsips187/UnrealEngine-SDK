...
#include "VyNode_Wallet_GetCryptoTokenBalanceByAddress.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetCryptoTokenBalanceByAddress : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCryptoTokenBalanceByAddressCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetCryptoTokenBalanceByAddress")};
};