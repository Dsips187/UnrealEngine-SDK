...
#include "VyNode_Wallet_TransferMultiToken.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_TransferMultiToken : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnTransferMultiTokenCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("TransferMultiToken")};
};