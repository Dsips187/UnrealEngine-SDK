...
#include "VyNode_Market_GetCollections.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetCollections : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCollectionsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetCollections")};
};