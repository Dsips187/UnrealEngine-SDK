...
#include "VyNode_Wallet_GetMultiTokenBalances.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetMultiTokenBalances : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetMultiTokenBalancesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetMultiTokenBalances")};
};