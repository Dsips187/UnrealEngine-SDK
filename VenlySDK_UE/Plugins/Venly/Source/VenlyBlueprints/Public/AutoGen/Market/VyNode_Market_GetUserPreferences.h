...
#include "VyNode_Market_GetUserPreferences.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserPreferences : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserPreferencesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserPreferences")};
};