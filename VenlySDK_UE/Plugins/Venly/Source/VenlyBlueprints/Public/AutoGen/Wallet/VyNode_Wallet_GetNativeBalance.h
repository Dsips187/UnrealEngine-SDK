...
#include "VyNode_Wallet_GetNativeBalance.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetNativeBalance : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetNativeBalanceCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetNativeBalance")};
};