...
#include "VyNode_Market_GetFulfillment.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetFulfillment : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetFulfillmentCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetFulfillment")};
};