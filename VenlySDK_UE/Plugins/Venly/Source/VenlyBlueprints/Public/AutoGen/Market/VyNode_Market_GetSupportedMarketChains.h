...
#include "VyNode_Market_GetSupportedMarketChains.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetSupportedMarketChains : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetSupportedMarketChainsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetSupportedMarketChains")};
};