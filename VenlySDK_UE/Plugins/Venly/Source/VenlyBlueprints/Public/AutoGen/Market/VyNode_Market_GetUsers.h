...
#include "VyNode_Market_GetUsers.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUsers : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUsersCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUsers")};
};