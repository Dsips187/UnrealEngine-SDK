...
#include "VyNode_Wallet_GetAllMultiTokenBalances.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetAllMultiTokenBalances : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetAllMultiTokenBalancesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetAllMultiTokenBalances")};
};