...
#include "VyNode_Wallet_GetClientsStatistics.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetClientsStatistics : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetClientsStatisticsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetClientsStatistics")};
};