...
#include "VyNode_Market_ApproveOfferTx.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_ApproveOfferTx : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnApproveOfferTxCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("ApproveOfferTx")};
};