...
#include "VyNode_Wallet_UpdateMetadata.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_UpdateMetadata : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnUpdateMetadataCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("UpdateMetadata")};
};