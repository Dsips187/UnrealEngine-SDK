...
#include "VyNode_Market_TerminateOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_TerminateOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnTerminateOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("TerminateOffer")};
};