...
#include "VyNode_Market_CreateSubUser.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CreateSubUser : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateSubUserCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CreateSubUser")};
};