...
#include "VyNode_Nft_GetTokens.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetTokens : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTokensCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetTokens")};
};