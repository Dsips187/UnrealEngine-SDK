...
#include "VyNode_Nft_AddNftImage.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_AddNftImage : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnAddNftImageCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("AddNftImage")};
};