...
#include "VyNode_Market_FindHotOffers.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_FindHotOffers : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnFindHotOffersCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("FindHotOffers")};
};