...
#include "VyNode_Wallet_GetMultiTokenBalancesByAddress.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetMultiTokenBalancesByAddress : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetMultiTokenBalancesByAddressCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetMultiTokenBalancesByAddress")};
};