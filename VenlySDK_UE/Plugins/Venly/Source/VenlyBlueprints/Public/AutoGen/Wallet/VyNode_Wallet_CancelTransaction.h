...
#include "VyNode_Wallet_CancelTransaction.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_CancelTransaction : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCancelTransactionCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("CancelTransaction")};
};