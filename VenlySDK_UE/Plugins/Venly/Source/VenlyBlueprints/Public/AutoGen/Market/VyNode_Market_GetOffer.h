...
#include "VyNode_Market_GetOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetOffer")};
};