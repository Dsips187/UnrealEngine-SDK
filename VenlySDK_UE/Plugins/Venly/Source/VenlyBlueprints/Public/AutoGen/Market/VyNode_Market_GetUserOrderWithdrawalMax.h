...
#include "VyNode_Market_GetUserOrderWithdrawalMax.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetUserOrderWithdrawalMax : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetUserOrderWithdrawalMaxCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetUserOrderWithdrawalMax")};
};