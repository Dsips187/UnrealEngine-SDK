...
#include "VyNode_Market_GetCreditBalances.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetCreditBalances : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCreditBalancesCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetCreditBalances")};
};