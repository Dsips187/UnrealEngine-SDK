...
#include "VyNode_Wallet_ImportWalletWifPassphrase.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_ImportWalletWifPassphrase : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnImportWalletWifPassphraseCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("ImportWalletWifPassphrase")};
};