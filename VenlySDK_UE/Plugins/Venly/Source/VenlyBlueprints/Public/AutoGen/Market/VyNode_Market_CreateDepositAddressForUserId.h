...
#include "VyNode_Market_CreateDepositAddressForUserId.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CreateDepositAddressForUserId : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateDepositAddressForUserIdCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CreateDepositAddressForUserId")};
};