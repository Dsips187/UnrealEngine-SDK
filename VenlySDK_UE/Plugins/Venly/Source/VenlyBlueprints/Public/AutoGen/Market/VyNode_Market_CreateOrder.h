...
#include "VyNode_Market_CreateOrder.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_CreateOrder : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateOrderCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("CreateOrder")};
};