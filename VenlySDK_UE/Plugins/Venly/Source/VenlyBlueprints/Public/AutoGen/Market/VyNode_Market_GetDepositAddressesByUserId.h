...
#include "VyNode_Market_GetDepositAddressesByUserId.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_GetDepositAddressesByUserId : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetDepositAddressesByUserIdCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("GetDepositAddressesByUserId")};
};