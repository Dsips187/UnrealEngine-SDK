...
#include "VyNode_Ext_CreateMarketUserForUser.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Ext_CreateMarketUserForUser : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnCreateMarketUserForUserCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Provider")};
	inline static const FName NAME_AuthoredName{TEXT("CreateMarketUserForUser")};
};