...
#include "VyNode_Wallet_GetWallets.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetWallets : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetWalletsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetWallets")};
};