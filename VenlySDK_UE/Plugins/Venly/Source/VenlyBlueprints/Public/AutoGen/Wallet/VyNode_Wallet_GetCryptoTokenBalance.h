...
#include "VyNode_Wallet_GetCryptoTokenBalance.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetCryptoTokenBalance : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetCryptoTokenBalanceCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetCryptoTokenBalance")};
};