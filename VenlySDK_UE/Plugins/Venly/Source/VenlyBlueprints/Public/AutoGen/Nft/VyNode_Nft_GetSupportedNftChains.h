...
#include "VyNode_Nft_GetSupportedNftChains.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetSupportedNftChains : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetSupportedNftChainsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetSupportedNftChains")};
};