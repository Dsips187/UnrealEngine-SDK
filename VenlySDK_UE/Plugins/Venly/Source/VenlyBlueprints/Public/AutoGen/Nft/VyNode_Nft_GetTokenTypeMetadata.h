...
#include "VyNode_Nft_GetTokenTypeMetadata.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Nft_GetTokenTypeMetadata : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetTokenTypeMetadataCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Nft")};
	inline static const FName NAME_AuthoredName{TEXT("GetTokenTypeMetadata")};
};