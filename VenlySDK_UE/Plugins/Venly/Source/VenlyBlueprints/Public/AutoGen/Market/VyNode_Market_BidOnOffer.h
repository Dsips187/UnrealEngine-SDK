...
#include "VyNode_Market_BidOnOffer.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Market_BidOnOffer : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnBidOnOfferCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Market")};
	inline static const FName NAME_AuthoredName{TEXT("BidOnOffer")};
};