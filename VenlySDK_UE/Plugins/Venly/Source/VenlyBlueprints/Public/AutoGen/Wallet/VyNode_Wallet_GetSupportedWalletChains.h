...
#include "VyNode_Wallet_GetSupportedWalletChains.generated.h"

UCLASS()
class VENLYBLUEPRINTS_API UVyNode_Wallet_GetSupportedWalletChains : public UVyNode_Api
{
	GENERATED_BODY()
...
private:
	...
	inline static const FName NAME_OnCompleteDelegate{TEXT("VyOnGetSupportedWalletChainsCompleteBP")};
	inline static const FName NAME_ApiName{TEXT("Wallet")};
	inline static const FName NAME_AuthoredName{TEXT("GetSupportedWalletChains")};
};